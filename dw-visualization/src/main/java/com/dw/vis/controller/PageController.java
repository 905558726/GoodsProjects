...
public class PageController {
    ...
    public String categoryRevenue() { return "category-revenue"; }

    @GetMapping("/daily-sales-trend")
    public String dailySalesTrend() { return "daily-sales-trend"; }

    @GetMapping("/user-value")
    public String userValue() { return "user-value"; }

    @GetMapping("/product-ranking")
    public String productRanking() { return "product-ranking"; }

    @GetMapping("/regional-sales")
    public String regionalSales() { return "regional-sales"; }
